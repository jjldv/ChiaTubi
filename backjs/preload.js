...
contextBridge.exposeInMainWorld('electronAPI', {
    ...
    CreateTempFileStore: (Chanel,Type) => ipcRenderer.invoke('CreateTempFileStore', Chanel,Type),
    DeleteTempFileStore: (Chanel,Type) => ipcRenderer.invoke('DeleteTempFileStore', Chanel,Type),
